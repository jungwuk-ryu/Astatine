# Astatine configuration (`shreddedpaper.yml`)

This file documents the current Astatine defaults as implemented by
`ShreddedPaperConfiguration`. The generated runtime file is still named
`shreddedpaper.yml` for compatibility with existing deployments.
...
# Astatine-specific optimizations.
optimizations:
