...
Generated: 2026-04-27T12:20:23.480570Z
...
| Category | Count |
| --- | ---: |
| entity movement/teleport/player tick | 602 |
| natural spawning/entity add/structure sync load | 148 |
| player chunk send/post-processing/stale holder broadcast | 1 |
| scheduled tick/neighbor/fluid-leaf-redstone | 175 |
| uncategorized sync-load risk | 720 |

## Candidates

### AO-AST-36DEE94F - AST call getChunkAt in RegionizedPlayerChunkLoader.java
- Severity: critical
- Category: entity movement/teleport/player tick
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/ca/spottedleaf/moonrise/patches/chunk_system/player/RegionizedPlayerChunkLoader.java:510`
- Context: `PlayerChunkLoaderData#sendUnloadChunkRaw`
- Receiver: `player.getBukkitEntity().getWorld()`
- Method: `getChunkAt`
- Evidence: `player.getBukkitEntity().getWorld().getChunkAt(new ChunkPos(chunkX, chunkZ).longKey)`
- Suggested fix: Guard with isChunkLoaded or route through async chunk loading before chunk access.

### AO-AST-B5211B47 - AST call getChunkAt in PlayerChunkSender.java
- Severity: critical
- Category: entity movement/teleport/player tick
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/PlayerChunkSender.java:54`
- Context: `PlayerChunkSender#dropChunk`
- Receiver: `player.getBukkitEntity().getWorld()`
- Method: `getChunkAt`
- Evidence: `player.getBukkitEntity().getWorld().getChunkAt(chunkPos.longKey)`
- Suggested fix: Guard with isChunkLoaded or route through async chunk loading before chunk access.

### AO-AST-E0F9BB99 - AST call getChunkAt in ServerGamePacketListenerImpl.java
- Severity: critical
- Category: entity movement/teleport/player tick
- Sink: bukkit-chunk-load
...
- Method: `getChunkAt`
- Evidence: `this.player.level().getChunkAt(pos)`
- Suggested fix: Guard with isChunkLoaded or route through async chunk loading before chunk access.

### AO-AST-0C69A204 - AST call getChunkAt in Entity.java
- Severity: critical
- Category: entity movement/teleport/player tick
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:1896`
- Context: `Entity#adjustSpawnLocation`
- Receiver: `level`
- Method: `getChunkAt`
- Evidence: `level.getChunkAt(blockPos)`
- Suggested fix: Guard with isChunkLoaded or route through async chunk loading before chunk access.

### AO-AST-0A0F7758 - AST call getChunkAt in Level.java
- Severity: critical
- Category: entity movement/teleport/player tick
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/Level.java:1645`
...
### AO-AST-9C22F5C6 - AST call getChunkAt in Level.java
- Severity: critical
- Category: entity movement/teleport/player tick
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/Level.java:1658`
...
### AO-AST-8CFDE67F - AST call getChunkAt in Level.java
- Severity: critical
- Category: entity movement/teleport/player tick
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/Level.java:1664`
...
### AO-AST-08D4BF5C - AST call getChunkAt in Level.java
- Severity: critical
- Category: entity movement/teleport/player tick
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/Level.java:1891`
...
### AO-AST-BCCA4376 - AST call getChunk in LevelHelper.java
- Severity: critical
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: getchunk-load-true
- Location: `shreddedpaper-server/src/minecraft/java/alternate/current/wire/LevelHelper.java:40`
- Context: `LevelHelper#setWireState`
- Receiver: `level`
- Method: `getChunk`
- Evidence: `level.getChunk(x >> 4, z >> 4, ChunkStatus.FULL, true)`
- Suggested fix: Use getChunkIfLoadedImmediately/getChunk(..., false), prefetch asynchronously, or hand off to the owning region.

### AO-AST-297B48E9 - AST call getChunkAt in CraftChunk.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftChunk.java:136`
...
### AO-AST-B44754A4 - AST call getChunkAt in CraftChunk.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftChunk.java:155`
- Context: `CraftChunk#getTileEntities`
- Receiver: `this.getWorld()`
- Method: `getChunkAt`
- Evidence: `this.getWorld().getChunkAt(this.x, this.z)`
...
### AO-AST-494F4D03 - AST call loadChunk in CraftChunk.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftChunk.java:183`
...
### AO-AST-4BC871E2 - AST call loadChunk in CraftChunk.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftChunk.java:188`
- Context: `CraftChunk#load`
- Receiver: `this.getWorld()`
- Method: `loadChunk`
...
### AO-AST-3BE35087 - AST call getChunk in CraftWorld.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: getchunk-load-true
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftWorld.java:380`
...
### AO-AST-5CF009D6 - AST call getChunkAt in CraftWorld.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftWorld.java:388`
- Context: `CraftWorld#getChunkAt`
- Receiver: `this`
- Method: `getChunkAt`
...
### AO-AST-54D66F1E - AST call getChunkAt in CraftWorld.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftWorld.java:398`
- Context: `CraftWorld#getChunkAt`
- Receiver: `this`
- Method: `getChunkAt`
...
### AO-AST-18B0E2FE - AST call getChunk in CraftWorld.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: getchunk-load-true
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftWorld.java:538`
...
### AO-AST-71992F18 - AST call getChunk in CraftWorld.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: getchunk-load-true
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftWorld.java:543`
- Context: `CraftWorld#loadChunk`
- Receiver: `this.world.getChunkSource()`
- Method: `getChunk`
...
### AO-AST-E6DB63CD - AST call loadChunk in CraftWorld.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftWorld.java:565`
- Context: `CraftWorld#loadChunk`
- Receiver: `this`
- Method: `loadChunk`
...
### AO-AST-CA88D63C - AST call getChunkAt in CraftWorld.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftWorld.java:576`
...
### AO-AST-2F85160A - AST call getChunkAt in CraftWorld.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftWorld.java:621`
...
### AO-AST-CD04C428 - AST call getChunkAt in CraftWorld.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftWorld.java:926`
- Context: `CraftWorld#setBiome`
- Receiver: `this.world`
- Method: `getChunkAt`
- Evidence: `this.world.getChunkAt(pos)`
- Suggested fix: Guard with isChunkLoaded or route through async chunk loading before chunk access.

### AO-AST-F266AD3E - AST call getChunkAt in CraftBlock.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/block/CraftBlock.java:142`
- Context: `CraftBlock#getChunk`
- Receiver: `this.getWorld()`
- Method: `getChunkAt`
- Evidence: `this.getWorld().getChunkAt(this)`
- Suggested fix: Guard with isChunkLoaded or route through async chunk loading before chunk access.

### AO-AST-6965CE8D - AST call getChunkAt in CraftBlockState.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/block/CraftBlockState.java:128`
- Context: `CraftBlockState#getChunk`
- Receiver: `this.world`
- Method: `getChunkAt`
- Evidence: `this.world.getChunkAt(this.getX() >> 4, this.getZ() >> 4)`
- Suggested fix: Guard with isChunkLoaded or route through async chunk loading before chunk access.

### AO-AST-EB4455FA - AST call getChunk in ChunkTaskScheduler.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: getchunk-load-true
- Location: `shreddedpaper-server/src/minecraft/java/ca/spottedleaf/moonrise/patches/chunk_system/scheduling/ChunkTaskScheduler.java:605`
...
### AO-AST-FF01AEB7 - AST call getChunkAt in FeatureHooks.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/io/papermc/paper/FeatureHooks.java:86`
- Context: `FeatureHooks#getSentChunks`
- Receiver: `world`
- Method: `getChunkAt`
- Evidence: `world.getChunkAt(iter.nextLong(), false)`
- Suggested fix: Guard with isChunkLoaded or route through async chunk loading before chunk access.

### AO-AST-6B78DC3C - AST call getChunkAt in FeatureHooks.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/io/papermc/paper/FeatureHooks.java:133`
- Context: `FeatureHooks#getPluginChunkTickets`
- Receiver: `world.getWorld()`
- Method: `getChunkAt`
- Evidence: `world.getWorld().getChunkAt(ChunkPos.getX(chunkKey), ChunkPos.getZ(chunkKey))`
- Suggested fix: Guard with isChunkLoaded or route through async chunk loading before chunk access.

### AO-AST-3E491CB2 - AST call syncLoad in ServerChunkCache.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: sync-load-call
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/level/ServerChunkCache.java:192`
...
### AO-AST-793701DF - AST call syncLoadNonFull in ServerLevel.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: sync-load-call
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/level/ServerLevel.java:373`
...
### AO-AST-42315871 - AST call getChunk in Level.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: getchunk-load-true
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/Level.java:364`
...
### AO-AST-3ED8FD67 - AST call getChunk in Level.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: getchunk-load-true
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/Level.java:1016`
- Context: `Level#getChunk`
- Receiver: `cps`
- Method: `getChunk`
...
### AO-AST-4829E332 - AST call getChunkAt in Level.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/Level.java:1116`
...
### AO-AST-ED5A557F - AST call getChunk in Level.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: getchunk-load-true
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/Level.java:1350`
...
### AO-AST-9B259E35 - AST call getChunkAt in Level.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/Level.java:1360`
...
### AO-AST-7A98D75E - AST call getChunkAt in SpreadingSnowyDirtBlock.java
- Severity: critical
- Category: uncategorized sync-load risk
- Sink: bukkit-chunk-load
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/SpreadingSnowyDirtBlock.java:83`
- Context: `SpreadingSnowyDirtBlock#randomTick`
- Receiver: `level`
- Method: `getChunkAt`
- Evidence: `level.getChunkAt(blockPos)`
- Suggested fix: Guard with isChunkLoaded or route through async chunk loading before chunk access.
...
### AO-AST-4B111053 - AST call getBlockEntity in CraftBlock.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/block/CraftBlock.java:516`
...
### AO-AST-A86FC7CE - AST call getBlockEntity in CraftBlock.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/block/CraftBlock.java:616`
...
### AO-AST-76998ED7 - AST call getBlockEntity in CraftBlockState.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/block/CraftBlockState.java:380`
...
### AO-AST-AF903A43 - AST call getBlockState in ServerPlayer.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/level/ServerPlayer.java:1481`
...
### AO-AST-DAF9729F - AST call getBlockState in ServerPlayer.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/level/ServerPlayer.java:1492`
- Context: `ServerPlayer#findRespawnAndUseSpawnBlockAsync`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos)`
...
### AO-AST-90C01F35 - AST call getBlockState in ServerPlayer.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/level/ServerPlayer.java:1510`
- Context: `ServerPlayer#findRespawnAndUseSpawnBlockAsync`
- Receiver: `level`
- Method: `getBlockState`
...
### AO-AST-8532B15B - AST call getBlockEntity in ServerPlayer.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/level/ServerPlayer.java:1549`
...
### AO-AST-96846B60 - AST call getBlockState in ServerPlayer.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/level/ServerPlayer.java:1729`
...
### AO-AST-392FE97A - AST call getBlockEntity in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:989`
- Context: `ServerGamePacketListenerImpl#handleSetCommandBlock`
- Receiver: `this.player.level()`
- Method: `getBlockEntity`
...
### AO-AST-D3655C8F - AST call getBlockState in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:999`
- Context: `ServerGamePacketListenerImpl#handleSetCommandBlock`
- Receiver: `this.player.level()`
- Method: `getBlockState`
...
### AO-AST-56481A39 - AST call setBlockEntity in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: set-block-entity
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1011`
- Context: `ServerGamePacketListenerImpl#handleSetCommandBlock`
- Receiver: `this.player.level().getChunkAt(pos)`
- Method: `setBlockEntity`
- Evidence: `this.player.level().getChunkAt(pos).setBlockEntity(blockEntity)`
- Suggested fix: Ensure the target chunk is loaded and owned, or resume on the owning region before mutation.

### AO-AST-30BB5266 - AST call getBlockState in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1078`
...
### AO-AST-CAA9BDFC - AST call getBlockEntity in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1093`
...
### AO-AST-E819D966 - AST call getBlockState in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1181`
...
### AO-AST-22C50578 - AST call getBlockEntity in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1182`
- Context: `ServerGamePacketListenerImpl#handleSetStructureBlock`
- Receiver: `this.player.level()`
- Method: `getBlockEntity`
- Evidence: `this.player.level().getBlockEntity(pos)`
...
### AO-AST-176E0CBB - AST call getBlockState in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1234`
...
### AO-AST-1A228A66 - AST call getBlockEntity in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1235`
- Context: `ServerGamePacketListenerImpl#handleSetTestBlock`
- Receiver: `this.player.level()`
- Method: `getBlockEntity`
...
### AO-AST-97D9365F - AST call getBlockEntity in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1248`
...
### AO-AST-7EF88C3E - AST call getBlockState in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1262`
- Context: `ServerGamePacketListenerImpl#handleTestInstanceBlockAction`
- Receiver: `this.player.level()`
- Method: `getBlockState`
- Evidence: `this.player.level().getBlockState(blockPos)`
...
### AO-AST-14F0E75F - AST call getBlockState in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1293`
...
### AO-AST-F0429601 - AST call getBlockEntity in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1294`
- Context: `ServerGamePacketListenerImpl#handleSetJigsawBlock`
- Receiver: `this.player.level()`
- Method: `getBlockEntity`
- Evidence: `this.player.level().getBlockEntity(pos)`
...
### AO-AST-A2355830 - AST call getBlockEntity in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1313`
...
### AO-AST-B81ECE6C - AST call getBlockEntity in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:1490`
...
### AO-AST-359E13AD - AST call getBlockEntity in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:2134`
...
### AO-AST-88EF1B16 - AST call getBlockState in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:2210`
- Context: `ServerGamePacketListenerImpl#handleUseItemOn`
- Receiver: `serverLevel`
- Method: `getBlockState`
- Evidence: `serverLevel.getBlockState(blockPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-ECC8E446 - AST call getBlockState in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:2230`
- Context: `ServerGamePacketListenerImpl#handleUseItemOn`
- Receiver: `serverLevel`
- Method: `getBlockState`
- Evidence: `serverLevel.getBlockState(blockPos)`
...
### AO-AST-C8241261 - AST call getBlockEntity in ServerGamePacketListenerImpl.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/server/network/ServerGamePacketListenerImpl.java:3655`
...
### AO-AST-1C1C4307 - AST call getBlockState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:1284`
- Context: `Entity#move`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(onPosLegacy)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-F0A64FDF - AST call getBlockState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:1351`
- Context: `Entity#applyMovementEmissionAndPlaySound`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(onPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-77A85968 - AST call getBlockState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:1425`
- Context: `Entity#applyEffectsFromBlocks`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(onPosLegacy)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-AE259819 - AST call getBlockState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:1534`
- Context: `Entity#getOnPos`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(blockPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-D0FDE63A - AST call getBlockState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:1927`
- Context: `Entity#getPrimaryStepSoundBlockPos`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(blockPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-783F490B - AST call getBlockState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:2026`
- Context: `Entity#doCheckFallDamage`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(onPosLegacy)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-45DCC8EC - AST call getBlockState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:2044`
- Context: `Entity#checkFallDamage`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(supportingPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-7D0C994F - AST call getFluidState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: fluidstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:2119`
...
### AO-AST-688A5021 - AST call getBlockState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:2210`
- Context: `Entity#getBlockStateOnLegacy`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(this.getOnPosLegacy())`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-9741F942 - AST call getBlockState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:2214`
- Context: `Entity#getBlockStateOn`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(this.getOnPos())`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-ED003A52 - AST call getBlockState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:2223`
- Context: `Entity#spawnSprintParticle`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(onPosLegacy)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-0F5860AA - AST call getBlockState in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:3997`
- Context: `Entity#moveTowardsClosestSpace`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(mutableBlockPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-15B104E6 - AST call getBlockEntity in Entity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/Entity.java:4155`
...
### AO-AST-0B1CF3F1 - AST call getBlockState in LivingEntity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/LivingEntity.java:3141`
- Context: `LivingEntity#travelFlying`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(this.getBlockPosBelowThatAffectsMyMovement())`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-6878CB9B - AST call getBlockState in LivingEntity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/LivingEntity.java:3159`
- Context: `LivingEntity#travelInAir`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(blockPosBelowThatAffectsMyMovement)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-F1FCE9E0 - AST call getBlockState in LivingEntity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/LivingEntity.java:4599`
...
### AO-AST-701517B5 - AST call getBlockState in LivingEntity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/LivingEntity.java:4719`
...
### AO-AST-7259AE40 - AST call getBlockState in LivingEntity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/LivingEntity.java:4736`
...
### AO-AST-963BAD01 - AST call getBlockState in LivingEntity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/LivingEntity.java:4741`
...
### AO-AST-0EB24E6B - AST call getFluidState in SpawnPlacementTypes.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: fluidstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/SpawnPlacementTypes.java:16`
- Context: `SpawnPlacementTypes#(initializer)`
- Receiver: `level`
- Method: `getFluidState`
- Evidence: `level.getFluidState(pos)`
- Suggested fix: Use getFluidIfLoaded or derive fluid state from a loaded BlockState.

### AO-AST-59F0B69D - AST call getBlockState in SpawnPlacementTypes.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/SpawnPlacementTypes.java:16`
...
### AO-AST-D250A2BA - AST call getFluidState in SpawnPlacementTypes.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: fluidstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/SpawnPlacementTypes.java:23`
- Context: `SpawnPlacementTypes#(initializer)`
- Receiver: `level`
- Method: `getFluidState`
- Evidence: `level.getFluidState(pos)`
...
### AO-AST-BB0143B0 - AST call getBlockState in SpawnPlacementTypes.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/SpawnPlacementTypes.java:30`
- Context: `#isSpawnPositionOk`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos1)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-59666C21 - AST call getBlockState in SpawnPlacementTypes.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/SpawnPlacementTypes.java:40`
- Context: `#isValidEmptySpawnBlock`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(pos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-88608FC5 - AST call getBlockState in SpawnPlacementTypes.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/SpawnPlacementTypes.java:47`
- Context: `#adjustSpawnPosition`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-70DD8AE0 - AST call getBlockState in TamableAnimal.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/TamableAnimal.java:293`
- Context: `TamableAnimal#canTeleportTo`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(pos.below())`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.
...
### AO-AST-4D595BB3 - AST call getBlockState in PathNavigation.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/ai/navigation/PathNavigation.java:316`
- Context: `PathNavigation#getGroundY`
- Receiver: `this.level`
- Method: `getBlockState`
- Evidence: `this.level.getBlockState(blockPos.below())`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-57EF3FCF - AST call getBlockState in PathNavigation.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/ai/navigation/PathNavigation.java:430`
...
### AO-AST-20C7B6AC - AST call getBlockState in PathNavigation.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/ai/navigation/PathNavigation.java:459`
...
### AO-AST-24CEF85B - AST call getBlockState in ItemEntity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/item/ItemEntity.java:189`
...
### AO-AST-3CEC71A0 - AST call getBlockState in EnderMan.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/monster/EnderMan.java:337`
- Context: `EnderMan#teleport`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(mutableBlockPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-E7F06225 - AST call getBlockState in EnderMan.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/monster/EnderMan.java:341`
- Context: `EnderMan#teleport`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(mutableBlockPos)`
...
### AO-AST-A644A273 - AST call getBlockState in EnderMan.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/monster/EnderMan.java:534`
...
### AO-AST-8CE12883 - AST call getBlockState in Shulker.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/entity/monster/Shulker.java:425`
- Context: `Shulker#isPositionBlocked`
- Receiver: `this.level()`
- Method: `getBlockState`
- Evidence: `this.level().getBlockState(pos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.
...
### AO-AST-12DBC031 - AST call getBlockEntity in ServerExplosion.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/ServerExplosion.java:457`
...
### AO-AST-95AA8BF6 - AST call getBlockEntity in ComparatorBlock.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/ComparatorBlock.java:159`
...
### AO-AST-16B73626 - AST call getBlockEntity in ComparatorBlock.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/ComparatorBlock.java:197`
...
### AO-AST-ED2F21E1 - AST call getBlockState in NetherPortalBlock.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/NetherPortalBlock.java:199`
...
### AO-AST-AD384192 - AST call getBlockState in NetherPortalBlock.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/NetherPortalBlock.java:222`
...
### AO-AST-06F31F6C - AST call getBlockState in NetherPortalBlock.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/NetherPortalBlock.java:228`
- Context: `NetherPortalBlock#getDimensionTransitionFromExit`
- Receiver: `entity.level()`
- Method: `getBlockState`
- Evidence: `entity.level().getBlockState(blockPos)`
...
### AO-AST-4C83ECE0 - AST call getBlockState in TheEndGatewayBlockEntity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/entity/TheEndGatewayBlockEntity.java:244`
...
### AO-AST-D254C20D - AST call getBlockState in TheEndGatewayBlockEntity.java
- Severity: high
- Category: entity movement/teleport/player tick
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/entity/TheEndGatewayBlockEntity.java:293`
...
### AO-AST-9A8D8581 - AST call setType in RegionLoadTestCommand.java
- Severity: high
- Category: natural spawning/entity add/structure sync load
- Sink: bukkit-block-write
- Location: `tools/region-load-test-plugin/src/main/java/io/multipaper/regionloadtest/RegionLoadTestCommand.java:1033`
...
### AO-AST-B963998B - AST call getBlockState in WireNode.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/alternate/current/wire/WireNode.java:104`
...
### AO-AST-24DEABBD - AST call getBlockState in RedstoneWireTurbo.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/io/papermc/paper/redstone/RedstoneWireTurbo.java:291`
- Context: `RedstoneWireTurbo#identifyNode`
- Receiver: `worldIn`
- Method: `getBlockState`
- Evidence: `worldIn.getBlockState(pos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-9EAE1DB1 - AST call getBlockState in RedstoneWireTurbo.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/io/papermc/paper/redstone/RedstoneWireTurbo.java:660`
- Context: `RedstoneWireTurbo#breadthFirstWalk`
- Receiver: `worldIn`
- Method: `getBlockState`
- Evidence: `worldIn.getBlockState(upd.self)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-BD2BB301 - AST call getBlockState in RedstoneWireTurbo.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/io/papermc/paper/redstone/RedstoneWireTurbo.java:938`
- Context: `RedstoneWireTurbo#updateNeighborShapes`
- Receiver: `level`
- Method: `getBlockState`
...
### AO-AST-0A9388A9 - AST call getBlockState in BaseRailBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/BaseRailBlock.java:82`
- Context: `BaseRailBlock#neighborChanged`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(pos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-2FA1FB0F - AST call scheduleTick in BaseRailBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: schedule-tick
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/BaseRailBlock.java:294`
...
### AO-AST-10702818 - AST call getBlockEntity in ComparatorBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/ComparatorBlock.java:148`
...
### AO-AST-E2810585 - AST call scheduleTick in ComparatorBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: schedule-tick
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/ComparatorBlock.java:152`
- Context: `ComparatorBlock#checkTickOnNeighbor`
- Receiver: `level`
- Method: `scheduleTick`
...
### AO-AST-704E75A3 - AST call getBlockEntity in DiodeBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/DiodeBlock.java:98`
...
### AO-AST-4C5AD0A6 - AST call scheduleTick in DiodeBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: schedule-tick
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/DiodeBlock.java:120`
...
### AO-AST-4645500A - AST call getBlockEntity in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:92`
...
### AO-AST-DBFFAE9E - AST call getBlockState in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:112`
...
### AO-AST-71104EF3 - AST call getBlockEntity in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:116`
- Context: `PistonBaseBlock#checkIfExtend`
- Receiver: `level`
- Method: `getBlockEntity`
- Evidence: `level.getBlockEntity(blockPos)`
...
### AO-AST-61185D31 - AST call getBlockEntity in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:183`
...
### AO-AST-3B6F0C8D - AST call setBlockEntity in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: set-block-entity
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:200`
- Context: `PistonBaseBlock#triggerEvent`
- Receiver: `level`
- Method: `setBlockEntity`
...
### AO-AST-504DF228 - AST call getBlockState in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:209`
- Context: `PistonBaseBlock#triggerEvent`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos)`
...
### AO-AST-1E058136 - AST call getBlockEntity in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:212`
- Context: `PistonBaseBlock#triggerEvent`
- Receiver: `level`
- Method: `getBlockEntity`
- Evidence: `level.getBlockEntity(blockPos)`
...
### AO-AST-1A6F29A2 - AST call getBlockState in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:241`
- Context: `PistonBaseBlock#triggerEvent`
- Receiver: `level`
- Method: `getBlockState`
...
### AO-AST-F78C5BA8 - AST call getBlockState in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:291`
...
### AO-AST-4C6C500A - AST call getBlockState in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:304`
- Context: `PistonBaseBlock#moveBlocks`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos1)`
...
### AO-AST-17EE3E87 - AST call getBlockState in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:345`
- Context: `PistonBaseBlock#moveBlocks`
- Receiver: `level`
- Method: `getBlockState`
...
### AO-AST-2914B87E - AST call getBlockState in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:348`
- Context: `PistonBaseBlock#moveBlocks`
- Receiver: `level`
- Method: `getBlockState`
...
### AO-AST-02822125 - AST call getBlockState in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:350`
- Context: `PistonBaseBlock#moveBlocks`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(movedPos)`
...
### AO-AST-1A71736B - AST call getBlockState in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:358`
- Context: `PistonBaseBlock#moveBlocks`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos2)`
...
### AO-AST-F226CFDD - AST call getBlockEntity in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: block-entity-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:359`
- Context: `PistonBaseBlock#moveBlocks`
- Receiver: `level`
- Method: `getBlockEntity`
- Evidence: `level.getBlockEntity(blockPos2)`
...
### AO-AST-A8AFBACA - AST call getBlockState in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:375`
- Context: `PistonBaseBlock#moveBlocks`
- Receiver: `level`
- Method: `getBlockState`
...
### AO-AST-5724E967 - AST call getBlockState in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:383`
- Context: `PistonBaseBlock#moveBlocks`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(oldPos)`
...
### AO-AST-7F5C1EE0 - AST call setBlockEntity in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: set-block-entity
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:386`
- Context: `PistonBaseBlock#moveBlocks`
- Receiver: `level`
- Method: `setBlockEntity`
...
### AO-AST-19D6EB05 - AST call setBlockEntity in PistonBaseBlock.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: set-block-entity
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/piston/PistonBaseBlock.java:406`
- Context: `PistonBaseBlock#moveBlocks`
- Receiver: `level`
- Method: `setBlockEntity`
...
### AO-AST-1E91152D - AST call getFluidState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: fluidstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:108`
...
### AO-AST-739AE07A - AST call getBlockState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:113`
- Context: `FlowingFluid#getFlow`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(mutableBlockPos)`
...
### AO-AST-16F995E5 - AST call getFluidState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: fluidstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:115`
- Context: `FlowingFluid#getFlow`
- Receiver: `level`
- Method: `getFluidState`
- Evidence: `level.getFluidState(blockPos)`
...
### AO-AST-7F47E301 - AST call getBlockState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:153`
...
### AO-AST-FC5AAE7E - AST call getFluidState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: fluidstate-read
...
### AO-AST-A159AC25 - AST call getBlockState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:162`
...
### AO-AST-16424973 - AST call getBlockState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:241`
- Context: `FlowingFluid#getNewLiquid`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(mutableBlockPos.setWithOffset(pos, Direction.DOWN))`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-596A73BB - AST call getBlockState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:249`
- Context: `FlowingFluid#getNewLiquid`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos1)`
...
### AO-AST-7ACABE8B - AST call getFluidState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: fluidstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:423`
- Context: `FlowingFluid#sourceNeighborCount`
- Receiver: `level`
- Method: `getFluidState`
- Evidence: `level.getFluidState(blockPos)`
- Suggested fix: Use getFluidIfLoaded or derive fluid state from a loaded BlockState.

### AO-AST-CEA79136 - AST call getBlockState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:506`
...
### AO-AST-3A89E2F5 - AST call scheduleTick in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: schedule-tick
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:530`
- Context: `FlowingFluid#tick`
- Receiver: `level`
- Method: `scheduleTick`
...
### AO-AST-8B97BA2A - AST call getFluidState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: fluidstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:542`
...
### AO-AST-69EAF958 - AST call getBlockState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:604`
...
### AO-AST-E2E8D742 - AST call getBlockState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:610`
- Context: `SpreadContext#getBlockState`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(pos)`
...
### AO-AST-4B20052A - AST call getBlockState in FlowingFluid.java
- Severity: high
- Category: scheduled tick/neighbor/fluid-leaf-redstone
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/material/FlowingFluid.java:623`
- Context: `SpreadContext#isHole`
- Receiver: `this.level`
- Method: `getBlockState`
- Evidence: `this.level.getBlockState(blockPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.
...
### AO-AST-BB5D6FBD - AST call getBlockState in CraftWorld.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftWorld.java:759`
...
### AO-AST-606C0B15 - AST call getBlockState in CraftWorld.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/CraftWorld.java:762`
- Context: `CraftWorld#generateTree`
- Receiver: `this.world`
- Method: `getBlockState`
- Evidence: `this.world.getBlockState(position)`
...
### AO-AST-2E2C6A74 - AST call getBlockState in CraftBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/block/CraftBlock.java:78`
...
### AO-AST-C75987BD - AST call getFluidState in CraftBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: fluidstate-read
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/block/CraftBlock.java:82`
...
### AO-AST-7FDCF07B - AST call getBlockState in CraftBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/block/CraftBlock.java:163`
...
### AO-AST-41DC2065 - AST call setType in CraftBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: bukkit-block-write
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/block/CraftBlock.java:174`
...
### AO-AST-0D21FAD8 - AST call getBlockState in CraftBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/block/CraftBlock.java:230`
...
### AO-AST-443C0491 - AST call getBlockState in CraftBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `paper-server/src/main/java/org/bukkit/craftbukkit/block/CraftBlock.java:423`
...
### AO-AST-BECDCD97 - AST call getBlockState in CraftBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
...
### AO-AST-6DDCF86E - AST call getBlockState in CraftBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
...
### AO-AST-469790FC - AST call getBlockState in CraftBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
...
### AO-AST-B161ABBF - AST call getBlockState in CraftBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
...
### AO-AST-8313F4C7 - AST call getBlockState in CraftBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
...
### AO-AST-B8F33451 - AST call getBlockState in Level.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/Level.java:1098`
- Context: `Level#setBlock`
- Receiver: ``
- Method: `getBlockState`
...
### AO-AST-F67CF3D8 - AST call getBlockState in ServerExplosion.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/ServerExplosion.java:600`
...
### AO-AST-DD2B1018 - AST call getBlockState in ServerExplosion.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/ServerExplosion.java:612`
- Context: `ServerExplosion#interactWithBlocks`
- Receiver: `this.level`
- Method: `getBlockState`
- Evidence: `this.level.getBlockState(blockPos)`
...
### AO-AST-758153CA - AST call getBlockState in ServerExplosion.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/ServerExplosion.java:624`
...
### AO-AST-2492A87E - AST call getBlockState in ServerExplosion.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/ServerExplosion.java:624`
...
### AO-AST-0EF8A2E3 - AST call getBlockState in BaseRailBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/BaseRailBlock.java:34`
- Context: `BaseRailBlock#isRail`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(pos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-CE3712DC - AST call getBlockState in BaseRailBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/BaseRailBlock.java:74`
- Context: `BaseRailBlock#updateState`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(pos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-A313BBC6 - AST call getFluidState in BaseRailBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: fluidstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/BaseRailBlock.java:140`
...
### AO-AST-94C1A09D - AST call getBlockState in ComparatorBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/ComparatorBlock.java:102`
- Context: `ComparatorBlock#getInputSignal`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-FF9C1417 - AST call getBlockState in ComparatorBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/ComparatorBlock.java:107`
- Context: `ComparatorBlock#getInputSignal`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos)`
...
### AO-AST-9778B753 - AST call getBlockState in DetectorRailBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/DetectorRailBlock.java:131`
- Context: `DetectorRailBlock#updatePowerToConnected`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-73C5E689 - AST call getBlockState in DiodeBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/DiodeBlock.java:46`
- Context: `DiodeBlock#canSurvive`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-D1DAC867 - AST call scheduleTick in DiodeBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: schedule-tick
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/DiodeBlock.java:73`
...
### AO-AST-3EEF533D - AST call scheduleTick in DiodeBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: schedule-tick
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/DiodeBlock.java:170`
...
### AO-AST-51CEF5ED - AST call getBlockState in DiodeBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/DiodeBlock.java:208`
- Context: `DiodeBlock#shouldPrioritize`
- Receiver: `level`
- Method: `getBlockState`
...
### AO-AST-EE5432A6 - AST call getBlockState in NetherPortalBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/NetherPortalBlock.java:76`
...
### AO-AST-2D195452 - AST call getBlockState in NetherPortalBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/NetherPortalBlock.java:80`
- Context: `NetherPortalBlock#randomTick`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(pos)`
...
### AO-AST-69A96B89 - AST call getBlockState in NetherPortalBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/NetherPortalBlock.java:188`
- Context: `NetherPortalBlock#getExitPortalAsync`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos)`
...
### AO-AST-7D03CEED - AST call getBlockState in NetherPortalBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/NetherPortalBlock.java:195`
- Context: `NetherPortalBlock#getExitPortalAsync`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(blockPos1)`
...
### AO-AST-159020E0 - AST call getBlockState in NetherPortalBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/NetherPortalBlock.java:248`
...
### AO-AST-7A5E9CE5 - AST call getBlockState in NetherPortalBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/NetherPortalBlock.java:291`
...
### AO-AST-24D5C4D8 - AST call getBlockState in NetherPortalBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/NetherPortalBlock.java:291`
...
### AO-AST-5AB065CE - AST call getBlockState in PoweredRailBlock.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/PoweredRailBlock.java:105`
- Context: `PoweredRailBlock#isSameRailWithPower`
- Receiver: `level`
- Method: `getBlockState`
- Evidence: `level.getBlockState(state)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.
...
### AO-AST-B4A6416B - AST call getBlockState in RailState.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/RailState.java:22`
- Context: `RailState#isValid`
- Receiver: `this.level`
- Method: `getBlockState`
- Evidence: `this.level.getBlockState(this.pos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-60B8A9E9 - AST call getBlockState in RailState.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/RailState.java:101`
- Context: `RailState#getRail`
- Receiver: `this.level`
- Method: `getBlockState`
- Evidence: `this.level.getBlockState(pos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-F8B276A8 - AST call getBlockState in RailState.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/RailState.java:106`
- Context: `RailState#getRail`
- Receiver: `this.level`
- Method: `getBlockState`
- Evidence: `this.level.getBlockState(blockPos)`
...
### AO-AST-7AD3CEE2 - AST call getBlockState in RailState.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/RailState.java:111`
- Context: `RailState#getRail`
- Receiver: `this.level`
- Method: `getBlockState`
- Evidence: `this.level.getBlockState(blockPos)`
...
### AO-AST-C19943BF - AST call getBlockState in RailState.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/RailState.java:342`
- Context: `RailState#place`
- Receiver: `this.level`
- Method: `getBlockState`
- Evidence: `this.level.getBlockState(this.pos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.

### AO-AST-2338E77A - AST call getBlockState in RailState.java
- Severity: high
- Category: uncategorized sync-load risk
- Sink: blockstate-read
- Location: `shreddedpaper-server/src/minecraft/java/net/minecraft/world/level/block/RailState.java:365`
- Context: `RailState#getState`
- Receiver: `this.level`
- Method: `getBlockState`
- Evidence: `this.level.getBlockState(this.pos)`
- Suggested fix: Use getBlockStateIfLoaded when unloaded chunks are tolerable, or explicitly hand off/prefetch before reading.
